...
function useOpeningStatus() {
  ...
  // 🔴 CLOSED BUT BEFORE OPENING (same day)
  ...
  while (true) {
    nextDay = (nextDay + 1) % 7;
    if (nextDay !== 0) break; // skip Sunday
  }
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div>
            ...
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">
              Votre partenaire <span className="text-emerald-600">énergie solaire</span> à Fès
            </h2>

            <p className="text-gray-600 text-lg leading-relaxed mb-6">
              EcoCiel est spécialisée dans les solutions d’énergie solaire durables pour les particuliers et les entreprises.
            </p>
            ...
            <div className="flex items-center gap-3 p-4 bg-amber-50 border border-amber-200 rounded-xl">
              ...
              <span className="text-amber-700 font-semibold">5.0</span>
              <span className="text-amber-600 text-sm">Google Reviews</span>
            </div>
          </div>
          ...
          <div className="space-y-5">
            ...
            <div className="bg-gray-50 rounded-2xl p-6">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <a href="tel:+212661989339" className="text-emerald-600">
                    +212 6 61 98 93 39
                  </a>
                </div>
              </div>
            ...
            <div className="bg-gray-50 rounded-2xl p-6">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Lundi - Samedi : 08:30 - 18:00</p>
            ...
            <div className={`p-6 rounded-2xl ${
              isOpen ? 'bg-emerald-50' : 'bg-red-50'
            }`}>
